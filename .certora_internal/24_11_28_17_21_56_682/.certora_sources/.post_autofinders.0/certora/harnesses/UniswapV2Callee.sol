...
contract UniswapV2Callee is ArbitraryValues {
    ...
    function uniswapV2Call() external {
        // data is definitley has a length of 1 or 0 
        // indicating a swap operation with or without flash loan
        ...
        if (callbackChoice == 0)
            ...
            pool.swap(arbitraryUint(),arbitraryUint(),arbitraryAddress(),'0x');
